...
function bot_ui_ini() {
    ...
    var sure = function () {
        ...
        secondpart = function () {
            botui.message.add({
                ...
                botui.message.add({
                    delay: 1500,
                    content: "研究方向是智能电网，偶尔学点编程，但还没有合成路线"
                }).then(function () {
                    botui.message.add({
                        delay: 1200,
                        content: "将敲代码看成一种修行，但目前仅限于CV大法😂"
                    }).then(function () {
                        botui.message.add({
                            delay: 1500,
                            content: "喜欢刷剧和看番，不玩手游，端游🎮皆可"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
                                content: "专业方向可能跟编程没多大关系吧，但我相信自律给我自由，要努力去成为更优秀的自己💪"
                            }).then(function () {
                                botui.message.add({
                                    delay: 1800,
                                    content: "你还有什么想知道的？"
                                    ...
                                    botui.action.button({
                                        ...
                                        {
                                            text: "我是王多鱼，你有什么愿望尽管说🤵",
                                            value: "dream"
                                        }]
                                    }).then(function (b) {
                                        "why-mashiro" == b.value && thirdpart();
                                        "dream" == b.value && mydream()
                                    })
                                })
                            })
                        })
    ...
    mydream = function () {
        botui.message.add({
            delay: 600,
            content: "大家好，我是秦始皇👑，其实我并没有死，我在西安有100吨黄金，我现在需要2000元人民币解冻我在西安的黄金，你微信，支付宝转给我都可以。账号就是我的手机号码!转过来后，我明天直接带部队复活，让你统领三军!"
        }).then(function () {
            botui.action.button({
                delay: 1800,
                action: [{
    ...
    zp = function () {
        botui.message.add(
            {
                delay: 2000,
                content: "王总莫生气嘛😐，我也是活跃活跃气氛，不然你会觉得我只是个笨笨的机器人"
            }
        ).then(function () {
            botui.message.add({
                delay: 1500,
                content: "你有读过三体嘛，我的理想就是像罗辑那样，有一栋梦幻中的房子，远离尘世，慢下来享受生活"
            }).then(function () {
                botui.message.add({
                    delay: 1200,
                    content: "有一个像庄颜那样的女孩陪伴，一家人，幸福快乐的生活👪"
                })
                    .then(function () {
                        botui.message.add({
                            delay: 1000,
                            content: "😔,我知道这很不现实，不过我会朝着这个方向努力的"
                        })
                            .then(function () {
                                botui.action.button({
                                    delay: 1200,
                                    action: [{
                                        text: "😉努力就好，跟我说下你这个昵称吧！",
                                        value: "nuli"
                                    }]
                                })
                                    .then(function (f) {
                                        "nuli" == f.value && thirdpart();
                                    })
                            })
                    })
            })
    ...
    gc = function () {
        botui.message.add({
            delay: 500,
            content: "![...](https://gitee.com/lin-xi98/cloudimage/raw/master/goodby.jpg)"
        })
    };
    thirdpart = function () {
        botui.message.add({
            delay: 1e3,
            content: "Deemo这个名字来源于雷亚的一款游戏，名叫古树旋律，Deemo是其中的主角"
        }).then(function () {
            botui.action.button({
                delay: 1500,
                action: [{
        ...
        fourthpart = function () {
            botui.message.add({
                delay: 1e3,
                content: "Deemo讲述了一个很温馨的故事，是关于守护的，由于时间关系不就不多讲了，怕你觉得我罗里吧嗦（实则不想敲代码🙃）。"
            }).then(function () {
                botui.message.add({
                    delay: 1100,
                    content: "这里，这个知乎的回答写的非常详细了"
                }).then(function () {
                    botui.message.add({
                        delay: 1100,
                        content: "https://www.zhihu.com/question/24742168"
                    })
                }).then(function () {
                    botui.action.button({
                        delay: 1500,
        ...
        fifthpart = function () {
            botui.message.add({
                delay: 1e3,
                content: "redamancy,你爱着某人时 某人也在爱着你,💑"
            }).then(function () {
                botui.message.add({
                    delay: 1600,
                    content: "相遇就是缘分，点个收藏吧 ^_^"
                })
            })
        }
}
